...
const InstallPrompt = ({ forceShow = false }: InstallPromptProps) => {
  ...
  return (
    <AnimatePresence data-oid="-j1t:uy">
      {showPrompt && !installed && (
        ...
        >
          ...
          <button
            ...
            data-oid="4kni3.-"
          >
            <X size={18} data-oid="gz-z:5e" />
          </button>

          <div className="flex items-center" data-oid="e9-n1n:">
            <div
              className="mr-4 bg-gradient-to-tr from-cyan-500 to-blue-600 p-2 rounded-lg shadow-lg shadow-cyan-500/30"
              data-oid="xhi82uz"
            >
              <Download size={24} className="text-white" data-oid="6v7-kpn" />
            </div>
            <div data-oid="z7rnxid">
              <h3
              ...
              <p className="text-gray-300 text-sm mt-1" data-oid="b7d8qb4">
                Add to your home screen for easier access
              </p>
            </div>
          </div>

          <div className="mt-4 flex justify-end" data-oid="d2qa67z">
            <button
      ...
      {showAnimation && installed && (
        <motion.div
          ...
          data-oid="fva6p-:"
        >
          <div className="flex items-center" data-oid="_g4htli">
            <div className="mr-3" data-oid="33vsse3">
              <svg
            ...
            <p className="text-white font-medium" data-oid="eot7ri6">
