...
const ConstructionCalculator: FC = () => {
  ...
  return (
    <BaseCalculator
      ...
      data-oid="2tkpd63"
    >
      <div className="relative mb-8" data-oid="agpvl95">
        <div
          className="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none"
          data-oid=".ekm47t"
        >
          <Search className="h-4 w-4 text-cyan-400" data-oid="o1x3i-6" />
        </div>
        <Input
          type="search"
      ...
      <div className="mb-8" data-oid="b52rfy_">
        <div
          ...
          {currentCalculators.map((calc) => (
            ...
            >
              ...
              >
                ...
                <span className="relative z-10" data-oid="5c2cs4u">
                  Open Calculator
                </span>
              </Button>
            </div>
        ...
        {totalPages > 1 && (
          ...
          >
            ...
            <Button
              ...
              data-oid="091g.bw"
            >
              <ChevronLeft className="h-4 w-4 mr-1.5" data-oid="e6b1zoz" />{" "}
              Previous
            </Button>
            ...
            <div
              ...
              data-oid="pgj2zva"
            >
              <span className="font-medium" data-oid="8itn4:s">
                Page {currentPage}
              </span>{" "}
              of {totalPages}
              <span className="text-cyan-300/70 ml-2" data-oid="zfcf5gb">
            ...
            >
              Next{" "}
              <ChevronRight className="h-4 w-4 ml-1.5" data-oid="48flzzs" />
            </Button>
          </div>
        )}
      </div>
      ...
      {activeTab && (
        <div className="mt-8 mb-20" data-oid="lcavoc3">
          <div
          ...
          >
            ...
            <p className="text-sm text-cyan-300/80 relative" data-oid="31uzvti">
            ...
            {loadingState[activeTab] && (
              ...
              >
                <div
                  ...
                  data-oid="hjifmzx"
                >
                  <div className="relative" data-oid="cekh.8o">
                    <div
            ...
            {errors[activeTab] ? (
              ...
              >
                <div
                  ...
                  data-oid="-iqoiih"
                >
                  <div className="relative" data-oid="b4ynuie">
                    <div
                  ...
                  <p className="text-gray-300 mb-5" data-oid="9ly60d_">
                ...
                {validatedUrls[activeTab] === false && (
                  ...
                  >
                    ...
                    >
                      ...
                      <span data-oid="5k2ad5u">
                        <span className="font-medium" data-oid="aae7xqm">
                          Notice:
                        </span>{" "}
