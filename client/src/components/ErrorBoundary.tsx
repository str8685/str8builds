        ...
        >
          ...
          >
            ...
            <div
              ...
              data-oid="9mef20b"
            >
              <div className="star-small" data-oid="jswa90o"></div>
              <div className="star-medium" data-oid="olzsp0l"></div>
              <div className="star-large" data-oid="npx0ryh"></div>
            </div>
            ...
            <div
              ...
              data-oid="kdz-_y4"
            >
              <div className="text-center" data-oid=":z.f55f">
                <div
                ...
                <p className="text-slate-300 mb-6" data-oid="fooqf_f">
