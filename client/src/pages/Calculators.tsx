...
const Calculators: FC = () => {
  ...
  const renderCalculator = () => {
    switch (selectedCalculator) {
      case "materials":
        return <MaterialCalculator data-oid="ef7ic-l" />;
      case "ar-measure":
        return <ARMeasureTool data-oid="tewisck" />;
      case "ar-floorplan":
        return <ARFloorPlan data-oid="bn1oeku" />;
      case "ar-furniture":
        return <ARFurniturePlanner data-oid="ju3c:lm" />;
      case "ar-bubble":
        return <ARBubbleLevel data-oid="6fq02_r" />;
      case "ar-volume":
        return <VolumeDetector data-oid="jqe69-9" />;
      case "directory":
      default:
        return <CalculatorDirectory data-oid=".w:-ygi" />;
    }
  };
    ...
    >
      ...
      >
        <h2
          ...
          data-oid="_:6b8w4"
        >
          <span className="inline-block relative" data-oid="kp-j5b9">
            <span className="relative z-10" data-oid=".rxu2ql">
              STR8 Calculators
            </span>
            <span
        ...
        <div
          ...
          data-oid="ukwagew"
        >
          <i className="fas fa-lightbulb mr-2" data-oid="2k6wbha"></i>
          Professional Calculators
        </div>
      </div>

      {/* Category selection tabs */}
      <div className="mb-6 overflow-x-auto" data-oid="s4ndwkw">
        <div className="flex space-x-3 pb-2" data-oid="zyi6mb2">
          <button
            ...
            data-oid="_l-i:8m"
          >
            <i className="fas fa-th-large mr-2" data-oid="p9ikzhc"></i>
            All Categories
          </button>
          ...
          {calculatorCategories.map((category) => (
            <button
              ...
              data-oid="yo2r4cc"
            >
              <i className="fas fa-calculator mr-2" data-oid="dmagmde"></i>
              {category.name}
            </button>
          ))}
        </div>
      ...
      <GlassCard
        ...
        data-oid="vnt05eh"
      >
        <div className="flex items-center mb-6" data-oid="f_u5ukv">
          <div
            className="h-10 w-1 bg-gradient-to-b from-cyan via-electric to-transparent rounded-full mr-3"
            data-oid="x3s.aep"
          ></div>
          <p className="text-gray-200 text-lg font-light" data-oid="wg:lm7a">
            {selectedCategory === null
        ...
        {selectedCalculator === null ? (
            ...
            {allCalculators.map((calc) => (
              ...
              >
                ...
                <div
                  ...
                  data-oid="lh0b1t-"
                >
                  <span className="relative" data-oid="q9._51a">
                    <span className="relative z-10" data-oid="15z9x5g">
                      {calc.name}
                    </span>
                    <span
                ...
                <div
                  ...
                  data-oid="sl0n116"
                >
                  <i className="fas fa-arrow-right" data-oid="iupc47j"></i>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="w-full" data-oid="bh.39jt">
            <div
            ...
            >
              ...
              <button
                ...
                data-oid="oko6c2o"
              >
                <i className="fas fa-chevron-left mr-2" data-oid="vai-k41"></i>
                <span data-oid="t32dq92">Back to All</span>
              </button>
            </div>
