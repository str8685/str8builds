import { c as commonjsGlobal, _ as _typeof$1, g as getDefaultExportFromCjs } from "./index.js";
...
var defineGlobalProperty$3 = function(key, value) {
  try {
    defineProperty$5(globalThis$i, key, { value, configurable: true, writable: true });
  } catch (error) {
...
var isForced$2 = function(feature, detection) {
  ...
  return value === POLYFILL ? true : value === NATIVE ? false : isCallable$b(detection) ? fails$d(detection) : !!detection;
};
...
if (!set || !clear) {
  ...
  } else if (globalThis$a.addEventListener && isCallable$8(globalThis$a.postMessage) && !globalThis$a.importScripts && $location && $location.protocol !== "file:" && !fails$b(globalPostMessageDefer)) {
